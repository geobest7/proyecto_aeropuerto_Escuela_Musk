...
import sys
import os
sys.path.append("..")  # Añade el directorio padre a sys.path para encontrar el módulo entities

import warnings
warnings.filterwarnings("ignore", category=DeprecationWarning)  # Opcional: Ignorar advertencias de deprecación

from unittest import TestCase, main  # Asegúrate de importar main para ejecutar las pruebas
from entities.aeropuerto import Aeropuerto  # Importa la clase Aeropuerto

import pandas as pd
from pandas._testing import assert_series_equal  # Importa assert_series_equal para comparar Series de pandas
...
class TestAeropuerto(TestCase):
    def setUp(self):
        vuelos = pd.DataFrame.from_dict({'id': {0: 'VY4548', 1: 'VY3887', 2: 'VY1603', 3: 'VY3302', 4: 'VY1121'},
                                         ...
                                         'destino': {0: 'Helsinki', 1: 'Sevilla', 2: 'Nueva York', 3: 'Bruselas',
                                                     4: 'Paris'}})
    ...
    def test_calcula_fecha_despegue(self):
        expected_fecha_llegada = pd.to_datetime('2022-08-06 10:30:00')
